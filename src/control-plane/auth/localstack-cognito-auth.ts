 ...
 */
export interface LocalstackCognitoAuthProps {
  /**
 ...
 */
export class LocalstackCognitoAuth extends Construct implements IAuth {
  /**
  ...
  constructor(scope: Construct, id: string, props?: LocalstackCognitoAuthProps) {
    super(scope, id);
    ...
    this.wellKnownEndpointUrl = `https://localhost.localstack.cloud:4566/${this.userPool.userPoolId}/.well-known/openid-configuration`;
    this.jwtIssuer = `http://localhost.localstack.cloud:4566/${this.userPool.userPoolId}`;
    this.jwtAudience = [
    ...
    this.tokenEndpoint = `https://localhost.localstack.cloud:4566/_aws/cognito-idp/oauth2/token`;
